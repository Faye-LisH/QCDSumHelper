...
FourierXP[list_List,others___]:=FourierXP[#,others]&/@list




FourierXP[expr:Except[_List],{x_,pp_},OptionsPattern[]]:=Block[
{tmp,tmp2,tmpc,tmpcc,test,rule1,dindex,findex,f,fco,result=0,tempresult,opt=OptionValue[TrueGamma],
inverse=OptionValue[Inverse],sign=-1,null2,null,null5,nulllo,nullpo,nullindx,Flist={},lorindx={},times,li,wrong,i,j,k,p,showsteps=OptionValue[ShowSteps]},
...
(*-----------------------------------Expand numerator; get the vector ------------------------------------------*)
	tmp=QExpand[QSimplify2[tmp],x,lessdummy->True]//Expand;
