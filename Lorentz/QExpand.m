...
(*------------------------------------------------------------------------------------------------------------------- *)
(* ------(p^u)^2 \[Rule] p^u g^uu' p^u' ; write 4 or (D-4) vector as D vector times with 4 or (4-D) metric -----*)
...
(*  must generate new dummy indices to avoid conflict with the existed dummy indices, 
